...
get_tooltip_content = ('(function(d) {return d.term + "<br/>' + not_category_name + ' Count: " ' +
                       '+ d.ox +"<br/>' + category_name + ' Count: " + d.oy})')  # type: str
...
open('Demo_Global_scale_Log_Orig.html', 'wb').write(html_orig.encode('utf-8'))
...
open('Demo_Global_scale_Log.html', 'wb').write(html_compact.encode('utf-8'))